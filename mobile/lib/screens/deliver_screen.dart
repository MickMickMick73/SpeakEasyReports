    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              s.projectName.isNotEmpty ? '${s.projectName} — ready to send' : '${s.clientName} — ready to send',
            ...
            const SizedBox(height: 8),
            const Text('Run SpeakEasy server on your PC first, same Wi‑Fi.', style: TextStyle(color: AppColors.textMuted, fontSize: 13)),
            const SizedBox(height: 12),
